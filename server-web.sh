...
<html>
<head>
    <title>Campus de Quixadá - UFC</title>
</head>
<body>
    <h1>Campus de Quixadá - UFC</h1>
    <p>Trabalho Prático de Segurança da Informação</p>
...
echo "Servidor Web pronto: http://10.0.4.10 e https://10.0.4.10"